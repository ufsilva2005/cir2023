                                    ...
                                    <fieldset>	
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col px-md-1 col-md-2">
                                                ...
                                                <input type="text" class="form-control" value = "<?=$nomeImpressora; $_SESSION['antNomeImp']=$nomeImpressora;?>" name="nomeImp">
                                            </div>  
                                                        
                                            <div class="col px-md-1 col-md-2">
                                                <label for="inputSuccess" class="control-label">Nº de Série: </label>
                                                <input type="text" class="form-control" value = "<?=$numSerie; $_SESSION['antNumSerie']=$numSerie?>" name="numSerie">
                                            </div>

                                            <div class="col px-md-1 col-md-3">
                                                <label for="inputSuccess" class="control-label">IP: </label>
                                                <input type="text" class="form-control" value = "<?=$ipImpressora; $_SESSION['antNumIp']=$ipImpressora?>" name="ipImpressora"  pattern="((^|\.)((25[0-5])|(2[0-4]\d)|(1\d\d)|([1-9]?\d))){4}$" placeholder="000.000.000.000" oninvalid="setCustomValidity('Endereco ip invalido!')" onchange="try{setCustomValidity('')}catch(e){}" >
                                            </div>

                                            <div class="col px-md-1 col-md-3">
                                                <label for="inputSuccess" class="control-label">MAC:</label>
                                                <input type="text" class="form-control" value = "<?=$macImpressora; $_SESSION['antNumMac']=$macImpressora?>" name="numMac" maxlength="17" OnKeyPress="formatar('##:##:##:##:##:##', this)" pattern="([a-fA-F0-9]{2}[:]){5}([a-fA-F0-9]{2})$" oninvalid="setCustomValidity('Numero Mac inválido!')" onchange="try{setCustomValidity('')}catch(e){}"  >
                                            </div>	
                                        </div>                               
                                        ...
                                        <div class="row">
                                            <div class="col px-md-1 col-md-3">
                                                ...
                                                <select class="form-control" id="tipoTonner" name = "tipoTonner" >
                                                    <option value="<?php echo $tipoTonerBd; $_SESSION['tipoTonerBd'] = $tipoTonerBd;?>"> <?php echo $tipoToner;?></option>
                                                    <option> </option> 
                                                    <?php
                                            ...
                                            <div class="col px-md-1 col-md-3">
                                                <div class="custom-control custom-radio">
                                                    <label for="inputSuccess" class="control-label">Status: <?=$statusImpressora; $_SESSION['antStatusImp']=$statusImpressora?></label></br>													
                                        ...
                                        <div class="row">																						
                                            <div class="col px-md-1 col-md-2">
                                                ...
                                                <select class="form-control" id="divisao" name = "divisao" >
                                                    <option value="<?php echo $idDivisao1; $_SESSION['antDivisao'] = $idDivisao1;?>"> <?php echo $divisao1;?></option>
                                                    <option> </option>
                                                    <?php
                                                        include_once "../dao/DAO-controleCir.php";                                    
                                            ...
                                            <div class="col px-md-1 col-md-3">
                                                ...
                                                <select class="form-control" id="local" name = "local" >
                                                    <option><?=$localizacao1; $_SESSION['antLocalizacao']=$localizacao1?></option>
                                                    <option> </option>
                                            ...
                                            <div class="col px-md-1 col-md-2">
                                                ...
                                                value = "<?=$ramal1; $_SESSION['antRamal']=$ramal1?>" name="ramal"
                                                pattern="[0-9]{4}+$" 
                                                oninvalid="setCustomValidity('Somente Numeros!')" 
                                            ...
                                            <div class="col px-md-1 col-md-5">
                                                ...
                                                <input type="text" class="form-control" value = "<?=$respSetComp1; $_SESSION['antRespSetComp']=$respSetComp1?>" name="respSetComp">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col px-md-1 col-md-12">
                                                ...
                                                <input type="text" class="form-control" value = "<?=$nomeLocal1; $_SESSION['antNomeLocal']=$nomeLocal1?>" name="nomeLocal" id="nomeLocal" class="typeahead"/>
                                            </div>
                                        </div>
                                                        
                                        <div class="row">
                                            <div class="col px-md-1 col-md-12">
                                                <label for="inputSuccess" class="control-label">Observação: <?=$obsImpressora; $_SESSION['antObsImp']=$obsImpressora?></label>
