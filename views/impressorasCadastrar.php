                        ...
                        <div class="panel-content">                                
							<div class="col-md-12">	  									
                                <form name="cadastro" id="cadastro" class="form-horizontal" method="POST" action="../controllers/impressoraCadastrar.php" >
									<fieldset>
										<div class="row">
											<label><h5 class="text-primary">1-> Informações da Impressora </h5></label>
										</div>
										...
										<div class="row">
											<label><h5 class="text-primary">2-> Informações do Local da Impressora</h5> </label>
										</div>
										...
										<div class="row">
											<label><h5 class="text-primary">3-> Informações do Sistema </h5></label>
										</div>
										<div class="row">
                                            <div class="col px-md-1  col-md-2">
